                            ...
                            <div class="table-responsive">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="team">Leicester City</span>
                                            <span class="team">Sevilla FC</span>
                                        </td>
                                        <td>
                                            <span class="contry">Ulusal</span>
                                            <span class="lig">UFA</span>
                                        </td>
                                        <td>
                                            <span class="rate">1.75</span>
                                        </td>
                                        <td>
                                            <span class="rate">2.45</span>
                                        </td>
                                        <td>
                                            <span class="rate">1.98</span>
                                        </td>
                                        <td>
                                            <span class="up">2.5</span>
                                        </td>
                                        <td>
                                            <span class="rate">1.60</span>
                                        </td>
                                        <td>
                                            <span class="rate">1.80</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span class="team">Juventus Turin</span>
                                            <span class="team">FC Porto</span>
                                        </td>
                                        <td>
                                            <span class="contry">Ulusal</span>
                                            <span class="lig">UFA</span>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="time">21:45</span>
                                            <span class="date">15 Mrt</span>
                                        </td>
                                        <td>
                                            <span class="team">Atletico Madrid</span>
                                            <span class="team">Bayer Leverkusen</span>
                                        </td>
                                        <td>
                                            <span class="contry">Ulusal</span>
                                            <span class="lig">Şampiyonlar Ligi</span>
                                        </td>
                                        <td>
                                            <span class="rate">1.75</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="team">Sampaio Correa MA v Lo…</span>
                                            <span class="team">WILLGOLIVE</span>
                                        </td>
                                        <td>
                                            <span class="contry">Czech Republic</span>
                                            <span class="lig">FNL</span>
                                        </td>
                                        <td>
                                            <span class="rate">1.75</span>
                                        </td>
